...
struct HalfwordDataTransferRegister_Decoded
{
    uint8_t rnIndex, rdIndex, rmIndex;
    bool pFlag, uFlag, wFlag, lFlag;
    bool sFlag, hFlag;
};


struct HalfwordDataTransferImmediate_Decoded
{
    uint8_t rnIndex, rdIndex, offsetHigh, offsetLow;
    bool pFlag, uFlag, wFlag, lFlag;
    bool sFlag, hFlag;
};
...
/* Flag Definitions for LDRH/STRH:
