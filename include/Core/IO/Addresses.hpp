...
constexpr u32 BG2X_L    = 0x04000028;
constexpr u32 BG2X_H    = 0x0400002A;
constexpr u32 BG2Y_L    = 0x0400002C;
constexpr u32 BG2Y_H    = 0x0400002E;
...
constexpr u32 BG3X_L    = 0x04000038;
constexpr u32 BG3X_H    = 0x0400003A;
constexpr u32 BG3Y_L    = 0x0400003C;
constexpr u32 BG3Y_H    = 0x0400003E;
...
constexpr u32 SOUND2CNT_H = 0x0400006A;
...
constexpr u32 SOUND4CNT_H = 0x0400007A;
...
constexpr u32 WAVE_RAM0_L = 0x04000090;
constexpr u32 WAVE_RAM0_H = 0x04000092;
constexpr u32 WAVE_RAM1_L = 0x04000094;
constexpr u32 WAVE_RAM1_H = 0x04000096;
constexpr u32 WAVE_RAM2_L = 0x04000098;
constexpr u32 WAVE_RAM2_H = 0x0400009A;
constexpr u32 WAVE_RAM3_L = 0x0400009C;
constexpr u32 WAVE_RAM3_H = 0x0400009E;
...
// 32-bit / Multiplayer shared block
constexpr u32 SIODATA32   = 0x04000120;

constexpr u32 SIOMULTI0   = 0x04000120; // Parent
constexpr u32 SIOMULTI1   = 0x04000122; // Child 1
constexpr u32 SIOMULTI2   = 0x04000124; // Child 2
constexpr u32 SIOMULTI3   = 0x04000126; // Child 3

constexpr u32 SIOCNT      = 0x04000128;

// Shared address (mode-dependent)
constexpr u32 SIOMLT_SEND = 0x0400012A; // Multiplayer send
constexpr u32 SIODATA8    = 0x0400012A; // 8-bit / UART mode
